...
exports.deleteContactForm = exports.updateContactFormStatus = exports.getContactFormById = exports.getContactForms = exports.createContactForm = void 0;
...
const createContactForm = async (req, res) => {
    try {
        ...
        const newContact = new contact_1.default(contactData);
...
exports.getContactForms = getContactForms;
/**
...
const getContactFormById = async (req, res) => {
    try {
        const { id } = req.params;
        const contact = await contact_1.default.findById(id).populate("userId", "firstName lastName email");
        if (!contact) {
            res.status(404).json({
                success: false,
...
const updateContactFormStatus = async (req, res) => {
    try {
        ...
        const contact = await contact_1.default.findByIdAndUpdate(id, { status }, { new: true }).populate("userId", "firstName lastName email");
        if (!contact) {
            res.status(404).json({
                success: false,
                message: "Contact form submission not found",
...
exports.updateContactFormStatus = updateContactFormStatus;
/**
